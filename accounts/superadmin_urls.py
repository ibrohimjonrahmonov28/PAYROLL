...
urlpatterns = [
    ...
    path('payroll/freeze-toggle/', superadmin_views.superadmin_ticket_freeze_toggle, name='superadmin_ticket_freeze_toggle'),
    path('payroll/recalculate-unfrozen/', superadmin_views.superadmin_recalculate_unfrozen_tickets, name='superadmin_recalculate_unfrozen_tickets'),
